...
const Dashboard = () => {
  return (
    <div className="min-h-screen flex justify-center bg-gradient-to-br from-red-900 to-yellow-700">
        <aside className="bg-gradient-to-br bg-gray-900/40 text-gray-700 -translate-x-80 z-50 my-8 ml-4 min-h-max w-0 rounded-xl transition-transform duration-300 xl:translate-x-0 xl:w-72">
  ...
  <div className="xl:ml-6 ml-0 mr-4">
   ...
   {/* Contenedor principal */}
    ...
    <div className="mb-4 grid grid-cols-1 gap-6 xl:grid-cols-1">
        <div className="relative flex flex-col bg-clip-border pb-6 mb-4 rounded-xl bg-gray-900/40 text-gray-700 shadow-md overflow-hidden xl:col-span-2">
          <div className="relative bg-clip-border rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none m-0 flex p-6 justify-between">
            ...
            <div className=' w-3/4 ml-5'>
                <h2 className='text-xl text-gray-400 font-medium '>Perfil</h2>
                <h2 className='text-5xl text-white font-bold'>Juan Perez</h2>
            ...
            <button aria-expanded="false" aria-haspopup="menu" id=":r5:" className="relative middle none justify-end font-sans font-medium text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-8 max-w-[32px] h-8 max-h-[32px] rounded-lg text-xs text-blue-gray-500 hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30" type="button">
              ...
              <HiOutlinePencil className='h-12 w-12 stroke-white bg-transparent rounded-full p-2 hover:bg-white hover:stroke-slate-600'/>
              </span>
            </button>
          </div>
        ...
        <div className="relative flex flex-col items-center bg-clip-border rounded-xl bg-gradient-to-tr from-[#5c8001] to-[#7cb518] text-white shadow-md">
          ...
          <div className=" px-10 pt-11 pb-3">
            ...
            <h4 className="block antialiased tracking-normal font-sans text-5xl font-semibold leading-snug text-blue-gray-900">1.70</h4>
          </div>  
        ...
        <div className="relative flex flex-col items-center bg-clip-border rounded-xl bg-gradient-to-tr from-[#5c8001] to-[#7cb518] text-white shadow-md">
          ...
          <div className=" px-10 pt-11 pb-3">
            ...
            <h4 className="block antialiased tracking-normal font-sans text-5xl font-semibold leading-snug text-blue-gray-900">22</h4>
          </div>  
          <div className="border-t border-blue-gray-50 p-4">
            <p className="block antialiased font-sans text-end text-base leading-relaxed font-normal text-blue-gray-600">
              <strong className="text-4xl font-light text-white/60 ">Anios</strong>
            </p>
          </div>       
        </div>
        ...
        <div className="relative flex flex-col bg-clip-border pb-6 mb-4 rounded-xl bg-gray-900/40 text-gray-700 shadow-md overflow-hidden xl:col-span-2">
          <div className="relative bg-clip-border rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none m-0 flex p-6 justify-between">
            <div className=' w-3/4 ml-5 my-5'>
                <h2 className='text-5xl text-white font-bold text-center'>Tu requerimiento calorico Diario</h2>
            ...
            <button aria-expanded="false" aria-haspopup="menu" id=":r5:" className="relative middle none justify-end font-sans font-medium text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-8 max-w-[32px] h-8 max-h-[32px] rounded-lg text-xs text-blue-gray-500 hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30" type="button">
              <span className="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" stroke-width="3" stroke="white" aria-hidden="true" className="h-6 w-6">
    ...
    {/* Resumen del dia */}
      <div className="mb-4 grid grid-cols-1 gap-6 xl:grid-cols-1 bg-gradient-to-t rounded-xl bg-gray-900/40 text-gray-700">
      
      <div className="relative bg-clip-border rounded-xl overflow-hidden bg-transparent text-white shadow-none m-0 flex items-center justify-between p-6">
          <div className=' w-3/4 ml-5 my-5'>
                <h2 className='text-5xl text-white font-bold text-start'>Resumen de Hoy</h2>
            </div>
