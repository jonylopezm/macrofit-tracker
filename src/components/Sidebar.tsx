...
export const Sidebar = () => {
  return (
    <div className="bg-gradient-to-br bg-white text-gray-700 -translate-x-80 z-50 my-8 ml-4 min-h-max w-0 rounded-xl transition-transform duration-300 xl:translate-x-0 xl:w-72">
    ...
    <li>
      <a className="" href="/dashboard/food-record">
        <button className="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-gray-700 hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize" type="button">
          ...
          <p className="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">Resumenes</p>
        </button>
      </a>
    </li>
    <li>
